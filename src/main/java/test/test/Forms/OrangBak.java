 ...
 * @author user
 */
public class OrangBak extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrangBak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
